...
import { Card, CardHeader, CardBody, Field, Btn, Alert, Grid2, PageHeader, Badge } from '../components/ui/index.jsx'
        ...
        <CardBody>
          ...
          {config.comm_platform === 'discord' && (
            <div style={{ borderTop: '1px solid var(--c-border)', paddingTop: 18 }}>
              ...
              <Grid2>
                <Field label="Bot token" required hint="Discord Developer Portal → Bot → Token">
                ...
                <Field label="Trigger role name" hint="Role name that activates the bot">
        ...
        <CardBody>
          ...
          {config.pm_platform === 'taiga' && (
            <div style={{ borderTop: '1px solid var(--c-border)', paddingTop: 18 }}>
              ...
              <Field label="Instance URL" required hint="Your Taiga REST API base URL">
