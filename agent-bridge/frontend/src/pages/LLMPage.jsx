...
import { Card, CardHeader, CardBody, Field, Btn, PageHeader, Alert, Grid2, Badge } from '../components/ui/index.jsx'
    ...
    <div>
      ...
      <Card>
        ...
        <CardBody>
          ...
          <Field label="API key" required hint="Get your key from Google AI Studio (aistudio.google.com) → API keys">
